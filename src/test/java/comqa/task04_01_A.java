...
public class task04_01_A {
    ...
    //By blockFirstLevel=By.xpath("//ul[@id='box-apps-menu']/li");
    By blockFirstLevel=By.id("'box-apps-menu']");
    By blockSecondLevel=By.xpath(".//li/ul[@class='docs']");
    ...
    public void testOpenAllLeftMenu()  {
        ...
        try{
            ...
            WebElement block1=driver.findElement(blockFirstLevel);
            //List<WebElement> listMenu1 = block1.findElements(By.xpath(".//li"));
            List<WebElement> listMenu1 = driver.findElements(blockFirstLevel);
            int amountMenu1 = listMenu1.size();

            for (int i=1;i<=amountMenu1;i++) {

                block1=driver.findElement(blockFirstLevel);
                //WebElement currentRowFirstLevel=block1.findElement(By.xpath(".//li["+i+"]/a/span[@class='name']"));
                WebElement currentRowFirstLevel=driver.findElement(By.xpath(".//li["+i+"]/a/span[@class='name']"));

                System.out.println("==================================================================================");
                System.out.println(i + ": '" + currentRowFirstLevel.getText()+"';");

                if (i>1) {
                    WebElement headerElement = driver.findElement(headerOnPage);
                    currentRowFirstLevel.click();
                ...
                WebElement block2=block1.findElement(By.xpath(".//li[" + i + "]/ul[@class='docs']"));
                By allLeftMenuSecondLevel=By.xpath("//ul[@id='box-apps-menu']/li["+i+"]/ul/li");
                List<WebElement> listMenu2 = block2.findElements(By.xpath(".//li"));
