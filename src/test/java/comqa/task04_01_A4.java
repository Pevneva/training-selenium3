    ...
    public void testOpenAllLeftMenu()  {
        ...
        try{
            ...
            for (int i=0;i<amountMenu1;i++) {
                ...
                System.out.println(i + ": '" + listMenu1.get(i).getText() + "';");

                if (i>0) {
                    WebElement headerElement = driver.findElement(headerOnPage);

                    listMenu1.get(i).click();
            ...
            //    wait.until(presenceOfElementLocated(allLeftMenuSecondLevel));
